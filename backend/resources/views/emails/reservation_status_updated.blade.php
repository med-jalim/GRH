    ...
    <div class="card">
        ...
        @if($reservation->remise_pourcentage && $reservation->prix_avant_remise)
            <table class="details-table" style="margin-top: 20px; border-top: 2px dashed #cbd5e1; padding-top: 15px;">
                ...
                <tr>
                    <td class="label" style="color: #059669; font-weight: 700; font-size: 14px;">Remise ({{ $reservation->remise_pourcentage }}%)</td>
                    <td class="value" style="color: #059669; font-weight: 900; font-size: 15px;">- {{ number_format($reservation->prix_avant_remise - ($reservation->prix_total - ($reservation->taxe_sejour_total ?? 0)), 0, ',', ' ') }} MAD</td>
                </tr>
            </table>
        @endif
