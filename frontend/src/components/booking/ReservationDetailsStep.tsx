    ...
    <div>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-1.5">
          <Label htmlFor="hotel" className="text-slate-700 font-medium text-sm">
          ...
          <select
            ...
            onChange={(e) =>
              handleHotelChange(e.target.value ? Number(e.target.value) : null)
            }
        ...
        <div className="space-y-1.5">
          ...
          >
            Nombre total de personnes <span className="text-red-400">*</span>
          </Label>
          <Input
            id="totalOccupants"
            type="number"
            {...register("totalOccupants", { valueAsNumber: true })}
            className={errors.totalOccupants ? "border-red-400" : ""}
          />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-1.5">
            <Label
              ...
              className="text-slate-700 font-medium text-sm"
            >
              Date d'arrivée <span className="text-red-400">*</span>
            </Label>
            <Input
              id="checkIn"
              type="date"
          ...
          <div className="space-y-1.5">
            <Label
              ...
              className="text-slate-700 font-medium text-sm"
            >
              Date de départ <span className="text-red-400">*</span>
            </Label>
            <Input
              id="checkOut"
              type="date"
                ...
                <RoomRow
                  ...
                  availableOptions={typesWithPrices.filter(
                    (tp) =>
                      !formData.rooms
                        .map((r) => r.roomTypeId)
                        .includes(tp.type.id) || tp.type.id === room.roomTypeId,
                  )}
                  nights={nights}
                  index={i}
